...
class EntryDir: UITableViewController {
    ...
    func getHeightForTitle(postTitle: NSString) -> CGFloat {
        let constraintSize = CGSizeMake(300, CGFloat.max)
        let attributes = [NSFontAttributeName: UIFont(name: "Lato", size: 15.0)!]
        let titleHeight = postTitle.boundingRectWithSize(constraintSize,
